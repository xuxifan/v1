        ...
        if (!empty($postStr)){
                ...
                {//根据用户输入回复消息接口
                  if($keyword=="你好"){
                        ...
                        $msgType = "text";
                    $contentStr = '菜单'."<br/>".'0:U8部门'."<br/>".'1:U8产品';
                        $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                        echo $resultStr;
                  }else if($keyword=="0"){
                        $msgType = "text";
                        $contentStr = "U8部门包括公共平台、测试部、人力资源部等";
                        $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                        echo $resultStr;
                  }else if($keyword=="1"){
                        $msgType = "text";
                        $contentStr = "U8产品详情请登录<br>U8：http://www.yonyou.com/product/U8.aspx";
                        $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                        echo $resultStr;
                  }else if($keyword=="图片"){
                        $msgType = "image";
                        $picUrl="www.baidu.com/img/bdlogo.gif";
                    $resultStr = sprintf($textTp2, $fromUsername, $toUsername, $time, $msgType, $picUrl);
                        echo $resultStr;
                  }else{
                        $msgType = "text";
                    $contentStr = '菜单0:U8部门'."<br/>".'1:U8产品';
                        $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                        echo $resultStr;
                  }
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	public function getOAJoel($code){
