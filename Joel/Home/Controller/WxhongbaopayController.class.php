...
class WxhongbaopayController extends Controller {
	//Joel全局相关
...
/*		if($sid==''){
		...
		//自定义订单号，此处仅作举例
        $wxHongBaoHelper->setParameter("mch_billno", $options['mchid'].date('YmdHis').rand(1000, 9999));//订单号
...
//		dump($wxHongBaoHelper);die;
        ...
        $responseXml = $wxHongBaoHelper->postXmlSSLCurl($postXml,$url);dump($responseXml);die;
