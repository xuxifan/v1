                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> 我的分销中心 </span>
                        ...
                        <ul class="submenu">
                        	...
                        	<?php if(($_SESSION['S']['user']['lv']) != "4"): ?><li>
                                <a href="<?php echo U('S/Fxs/user');?>" data-loader="Joel-loader" data-loadername="分销商管理">
                                    <span class="menu-text">我的分销商</span>
                                </a>
                            </li><?php endif; ?>
                            <li>
                                <a href="<?php echo U('S/Fxs/yj');?>" data-loader="Joel-loader" data-loadername="分销商管理">
                                    <span class="menu-text">我的佣金详情</span>
                                </a>
                            </li>
                            <li>
                            	<a href="#" class="menu-dropdown">
		                            <span class="menu-text">我的提现订单</span>
		                            <i class="menu-expand"></i>
                        		</a>
                        		<ul class="submenu">
                                		<li>
                    ...
                    <li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> 我的会员 </span>
                            <i class="menu-expand"></i>
                        </a>
                        <ul class="submenu">
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                        		...
                        		<ul class="submenu">
                                    	<li>
                                        <a href="<?php echo U('S/Shop/order');?>" data-loader="Joel-loader" data-loadername="订单管理-全部订单">
	                                    	<i class="glyphicon glyphicon-asterisk"></i>
	                                    	<span class="menu-text">全部</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'1'));?>" data-loader="Joel-loader" data-loadername="订单管理-未支付订单">
	                                    	<i class="glyphicon glyphicon-heart-empty"></i>
	                                    	<span class="menu-text">未付款</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'2'));?>" data-loader="Joel-loader" data-loadername="订单管理-已支付订单">
	                                    	<i class="glyphicon glyphicon-usd"></i>
	                                    	<span class="menu-text">已付款</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'3'));?>" data-loader="Joel-loader" data-loadername="订单管理-已发货订单">
	                                    	<i class="glyphicon glyphicon-export"></i>
	                                    	<span class="menu-text">已发货</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'4'));?>" data-loader="Joel-loader" data-loadername="订单管理-退货中订单">
	                                    	<i class="glyphicon glyphicon-import"></i>
	                                    	<span class="menu-text">退货中</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'7'));?>" data-loader="Joel-loader" data-loadername="订单管理-退货完成">
	                                    	<i class="glyphicon glyphicon-saved"></i>
	                                    	<span class="menu-text">退货完成</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'5'));?>" data-loader="Joel-loader" data-loadername="订单管理-交易完成">
	                                    	<i class="glyphicon glyphicon-ok"></i>
	                                    	<span class="menu-text">交易完成</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'6'));?>" data-loader="Joel-loader" data-loadername="订单管理-交易关闭">
	                                    	<i class="glyphicon glyphicon-remove"></i>
	                                    	<span class="menu-text">交易关闭</span>
                                		</a>
                                		</li>
                                		<li>
                                		<a href="<?php echo U('S/Shop/order',array('status'=>'0'));?>" data-loader="Joel-loader" data-loadername="订单管理-交易取消">
