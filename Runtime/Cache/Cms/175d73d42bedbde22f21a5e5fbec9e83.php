	...
	<div class="col-xs-12 col-md-12">
		<div class="widget">
			<div class="widget-header bg-blue">
				...
				<span class="widget-caption">操作会员日志</span>
						...
						<form id="Joel-search">
							<label style="margin-bottom: 0px;">
								<select name="stype" class="form-control input-sm">
									...
									<option value='2' <?php if(($stype) == "2"): ?>selected<?php endif; ?>>按会员ID</option>
								</select>								
							</label>
							<label style="margin-bottom: 0px;">
								<input name="name" type="search" class="form-control input-sm" value="<?php echo ($name); ?>" placeholder="请输入搜索条件">
							</label>
							<a href="<?php echo U('Cms/Adminlog/vip/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="操作会员日志" data-search="Joel-search">
