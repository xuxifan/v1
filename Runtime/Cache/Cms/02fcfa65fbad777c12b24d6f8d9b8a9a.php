		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Cms/Vip/messageSet/');?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="会员消息">
					...
					<div class="pull-right">
						<!--<form id="Joel-search">
							...
							<a href="<?php echo U('Cms/Vip/message/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="会员消息" data-search="Joel-search">
				...
				<table id="Joel-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class="center "><a href="<?php echo U('Cms/Vip/messageSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="会员消息"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Cms/vip/message/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/vip/messageDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a></td>
...
<script type="text/javascript">
	...
	$('#Joel-delall').on('click',function(){
		...
		var toajax="<?php echo U('Cms/Vip/messageDel');?>"+"/id/"+chk;
		var funok=function(){
			var callok=function(){
				//成功删除后刷新
