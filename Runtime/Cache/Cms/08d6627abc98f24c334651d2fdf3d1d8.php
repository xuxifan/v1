		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Cms/Vip/levelSet/');?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="等级设置">
					...
					<div class="pull-right">
						<!--<form id="Joel-search">
							...
							<a href="<?php echo U('Cms/Vip/level/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="等级列表" data-search="Joel-search">
				...
				<table id="Joel-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class="center "><a href="<?php echo U('Cms/Vip/levelSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="等级设置"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Cms/Vip/level/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Vip/levelDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a></td>
...
<script type="text/javascript">
	...
	$('#Joel-delall').on('click',function(){
		...
		var toajax="<?php echo U('Cms/Vip/levelDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
